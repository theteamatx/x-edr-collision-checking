...
#ifndef COLLISION_CHECKING_GEOMETRY_SHAPES_SPHERE_H_
#define COLLISION_CHECKING_GEOMETRY_SHAPES_SPHERE_H_
...
#endif  // COLLISION_CHECKING_GEOMETRY_SHAPES_SPHERE_H_

...
#ifndef COLLISION_CHECKING_GEOMETRY_SHAPES_CAPSULE_H_
#define COLLISION_CHECKING_GEOMETRY_SHAPES_CAPSULE_H_
...
#endif  // COLLISION_CHECKING_GEOMETRY_SHAPES_CAPSULE_H_

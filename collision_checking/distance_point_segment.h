...
#ifndef COLLISION_CHECKING_DISTANCE_POINT_SEGMENT_H_
#define COLLISION_CHECKING_DISTANCE_POINT_SEGMENT_H_
...
#endif  // COLLISION_CHECKING_DISTANCE_POINT_SEGMENT_H_
